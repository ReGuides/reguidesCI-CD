          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">4.1. Техническая информация:</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">4.2. Географическая информация:</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">4.3. Поведенческие метрики:</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
