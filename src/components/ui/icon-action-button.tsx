...
interface IconActionButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'view' | 'edit' | 'delete' | 'feature' | 'publish' | 'primary' | 'secondary';
  size?: 'xs' | 'sm' | 'md' | 'lg';
  icon?: ReactNode;
  customColor?: string;
}
...
const IconActionButton = forwardRef<HTMLButtonElement, IconActionButtonProps>(
  ({ className, variant = 'view', size = 'sm', icon, customColor, children, ...props }, ref) => {
    ...
    const variantClasses = {
      ...
      primary: 'bg-purple-600 hover:bg-purple-700 text-white focus:ring-purple-500 border border-purple-600/20 hover:border-purple-700/40',
      secondary: 'bg-neutral-700 hover:bg-neutral-600 text-white focus:ring-neutral-500 border border-neutral-700/20 hover:border-neutral-600/40',
